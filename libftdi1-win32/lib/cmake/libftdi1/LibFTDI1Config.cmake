...
set ( LIBFTDI_FOUND 1 )
set ( LIBFTDI_USE_FILE     "/tmp/csr-spi-ftdi/libftdi1-win32/lib/cmake/libftdi1/UseLibFTDI1.cmake" )

set ( LIBFTDI_DEFINITIONS  "" )
set ( LIBFTDI_INCLUDE_DIR  "/tmp/csr-spi-ftdi/libftdi1-win32/include/libftdi1" )
set ( LIBFTDI_INCLUDE_DIRS "/tmp/csr-spi-ftdi/libftdi1-win32/include/libftdi1" )
set ( LIBFTDI_LIBRARY      "ftdi1" )
set ( LIBFTDI_LIBRARIES    "ftdi1;-L../../libusb-win32/MinGW32/static -lusb-1.0" )
set ( LIBFTDI_STATIC_LIBRARY      "ftdi1.a" )
set ( LIBFTDI_STATIC_LIBRARIES    "ftdi1.a;-L../../libusb-win32/MinGW32/static -lusb-1.0" )
set ( LIBFTDIPP_LIBRARY    "" )
set ( LIBFTDIPP_LIBRARIES  "" )
set ( LIBFTDI_LIBRARY_DIRS "/tmp/csr-spi-ftdi/libftdi1-win32/bin" )
set ( LIBFTDI_ROOT_DIR     "/tmp/csr-spi-ftdi/libftdi1-win32" )
